...
// icon-guess-the-word's room.js. Only the Host ever acts — the Display is a
// pure render target and never sends a game action, so there's no
// per-connection role/permission system here at all.

const ID_PREFIX = 'rebus-room-'; // distinct from the sibling games' prefixes
