...
// The following puzzles (card-39 through card-59) are sourced from
  ...
  },
  {
    id: 'jaywalking',
    answer: 'JAYWALKING',
    image: 'images/cards/card-132.png',
    description: 'html: A large bold letter "J" with two cartoon legs and sneakers attached at the bottom, mid-stride like it\'s walking (the letter "J" (said "jay") + walking legs = "JAYWALKING").',
    category: 'wordplay',
  },
  {
    id: 'holy-water',
    answer: 'HOLY WATER',
    image: 'images/cards/card-133.png',
    description: 'html: The word "WATER" large and centered, densely punched with two dozen small white circles (holes) of varying sizes, clipped so they only ever appear over the letter strokes themselves, never in the surrounding white space (WATER full of holes = "HOLY WATER").',
    category: 'phrase',
  },
  {
    id: 'butterfly',
    answer: 'BUTTERFLY',
    image: 'images/cards/card-134.png',
    description: 'html: The word "BUTTER" centered, with two pairs of yellow butterfly wings attached on either side, as if the word has wings (BUTTER + wings/FLY = "BUTTERFLY").',
    category: 'wordplay',
  },
  {
    id: 'nervous-breakdown',
    answer: 'NERVOUS BREAKDOWN',
    image: 'images/cards/card-135.png',
